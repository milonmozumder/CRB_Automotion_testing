...
def test_room_booking_medium_room_one_hour(driver):
    ...
    if test_data_set_one_hour["expected_cost_for_medium_room"] == Actual_cost_for_one_hour:
        print("Test Case Passed.Cost for one hour is $150")
    else:
        print("Test Case Failed.")
        print("Expected Cost: ", test_data_set_one_hour["expected_cost_for_medium_room"], "But Found: ", Actual_cost_for_one_hour)


def test_room_booking_medium_room_five_hour(driver):
    ...
    if test_data_set_five_hour["expected_cost_for_medium_room"] == Actual_cost_for_five_hour:
        print("Test Case Passed.Cost for five hour is $750")
    else:
        print("Test Case Failed.")
        print("Expected Cost: ", test_data_set_five_hour["expected_cost_for_medium_room"], "But Found: ", Actual_cost_for_five_hour)

def test_room_booking_medium_room_one_day(driver):
    ...
    if test_data_set_one_day["expected_cost_for_medium_room"] == Actual_cost_for_one_day:
        print("Test Case Passed.Cost for one day is $1200")
    else:
        print("Test Case Failed.")
        print("Expected Cost: ", test_data_set_one_day["expected_cost_for_medium_room"], "But Found: ", Actual_cost_for_one_day)

def test_room_booking_medium_room_three_day(driver):
    ...
    if test_data_set_three_day["expected_cost_for_medium_room"] == Actual_cost_for_three_day:
        print("Test Case Passed.Cost for three day is $3600")
    else:
        print("Test Case Failed.")
        print("Expected Cost: ",test_data_set_three_day["expected_cost_for_medium_room"], "But Found: ", Actual_cost_for_three_day)

def test_room_booking_medium_room_seven_day(driver):
    ...
    #Expected_cost_for_seven_day = "Total Cost: $8400"
    ...
    if test_data_set_seven_day["expected_cost_for_medium_room"] == Actual_cost_for_seven_day:
        print("Test Case Passed.Cost for seven day is $8400")
    else:
        print("Test Case Failed.")
        print("Expected Cost: ", test_data_set_seven_day["expected_cost_for_medium_room"], "But Found: ", Actual_cost_for_seven_day)
